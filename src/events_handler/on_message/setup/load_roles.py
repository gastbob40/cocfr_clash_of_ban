...
async def load_roles(client: discord.Client, message: discord.Message, args: List[str], config):
    ...
    return await message.channel.send(
        embed=EmbedsManager.complete_embed("The command was successful.", f'{len(res)} roles have been loaded.')
    )
